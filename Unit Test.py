...
class TestBookBotStats(unittest.TestCase):
    ...
    # Test Case 1: Word Count (Happy Path)
    ...
    # Test Case 2: Character Frequency & Lowercase Normalization (Edge Case)
    ...
    # Test Case 3: Character Dictionary Sorting (Descending Order)
